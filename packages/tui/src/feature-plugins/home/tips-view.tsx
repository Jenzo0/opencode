...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent JenzoCode from reading sensitive files",
  "Use {highlight}jenzocode run{/highlight} for non-interactive scripting",
  "Use {highlight}jenzocode --continue{/highlight} to resume the last session",
  "Use {highlight}jenzocode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}jenzocode serve{/highlight} for headless API access to JenzoCode",
  "Use {highlight}jenzocode run --attach{/highlight} to connect to a running server",
  "Run {highlight}jenzocode upgrade{/highlight} to update to the latest version",
  "Run {highlight}jenzocode auth list{/highlight} to see all configured providers",
  "Run {highlight}jenzocode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}jenzocode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}jenzocode debug config{/highlight} to troubleshoot configuration",
